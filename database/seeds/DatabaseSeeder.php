...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('characteristics')->insert([
        	...
        	['id' => 6, 'icon' => '1498610963.png', 'name' => 'Devoção à causa', 'description' => 'O personagem é simpatizante de determinada causa de tal maneira que daria a vida para vê-la frutífera.', 'type' => 1],
        	['id' => 7, 'icon' => '1498611051.png', 'name' => 'Competitivo', 'description' => 'O personagem entende coisas que não deveria como disputas de poder. Quando entra em alguma disputa, sempre leva a sério.', 'type' => 0],
        	...
        	['id' => 16, 'icon' => '1498612041.png', 'name' => 'Rebelde', 'description' => 'Seu personagem é muito propenso a se rebelar e não aceita regras impostas sem motivo.', 'type' => 1],
        	['id' => 17, 'icon' => '1498612094.png', 'name' => 'Propagador de Ideais', 'description' => 'Seu personagem acredita tanto numa ideia que acha que todas as pessoas devem pensar como ele.', 'type' => 1],
        	...
        	['id' => 19, 'icon' => '1498612292.png', 'name' => 'Megalomaníaco', 'description' => 'O personagem se importa apenas consigo mesmo, pois ele é o que há de mais perfeito em todo o mundo.', 'type' => 0],
        	...
        	['id' => 24, 'icon' => '1498612697.png', 'name' => 'Manipulador', 'description' => 'Sempre há um plano por trás de tudo para que todas as peças se mexam como este personagem quer.', 'type' => 1],
        	...
        	['id' => 28, 'icon' => '1498613045.png', 'name' => 'Alcólatra', 'description' => 'Há um problema com o álcool e esse personagem, pois ele não consegue parar de beber.', 'type' => 0],
        	...
        	['id' => 35, 'icon' => '1498613705.png', 'name' => 'Aversão à Rejeição', 'description' => 'Pelo simples medo de ser rejeitado, seu personagem se entrega ou se arrisca muito pouco. Talvez ele sofra muito com rejeições.', 'type' => 0],
        	['id' => 36, 'icon' => '1498613940.png', 'name' => 'Libidinoso', 'description' => 'Sexualidade representa uma grande fatia da vida do seu personagem. Possivelmente enxerga órgãos genitais em vez de pessoas na rua.', 'type' => 0],
        	...
        	['id' => 40, 'icon' => '1498614125.png', 'name' => 'Doente Crônico', 'description' => 'Alguma doença acomete o personagem com uma frequência absurda.', 'type' => 0],
        	['id' => 41, 'icon' => '1498614242.png', 'name' => 'Autista', 'description' => 'Existe mais de uma coisa no mundo que, por mais que seu personagem tente, ele nunca vai entendê-la da maneira como ela realmente é.', 'type' => 0],
        	...
        	['id' => 45, 'icon' => '1498614545.png', 'name' => 'Amaldiçoado', 'description' => 'Devido a um evento passado, seu personagem está amaldiçoado. Alguma força sobrenatural o prejudica de maneira constantemente.', 'type' => 0],
        	['id' => 46, 'icon' => '1498614603.png', 'name' => 'Fora dos Padrões', 'description' => 'Seu personagem está alheio aos padrões da própria cultura. Ele pode sofrer consequências por conta disso.', 'type' => 1],
        	['id' => 47, 'icon' => '1498614772.png', 'name' => 'Perseguido', 'description' => 'O lugar onde seu personagem viveu a maior parte da vida agora quer sua cabeça.', 'type' => 1],
        	...
        	['id' => 49, 'icon' => '1498614957.png', 'name' => 'Reverenciado', 'description' => 'Seu personagem tem subordinados que o respeitam e talvez até morram por você.', 'type' => 1],
        	...
        	['id' => 53, 'icon' => '1498615262.png', 'name' => 'Beleza Incomparável', 'description' => 'Seu personagem é tão bonito que isso pode até chegar a ser um problema para ele.', 'type' => 1],
        	['id' => 54, 'icon' => '1498615369.png', 'name' => 'Boa Fama', 'description' => 'Algo que sobre seu personagem é bem público, e as pessoas o tratam bem por isso.', 'type' => 1],
        	['id' => 55, 'icon' => '1498615416.png', 'name' => 'Aversão ao Estrangeiro', 'description' => 'Tudo que é de fora deve ser retirado do recinto ou exterminado.', 'type' => 1],
        	...
        	['id' => 60, 'icon' => '1498615715.png', 'name' => 'Higiênico', 'description' => 'Higiene é essencial e, para o personagem, é uma obsessão.', 'type' => 0],
        	...
        	['id' => 64, 'icon' => '1498616010.png', 'name' => 'Frieza', 'description' => 'Seu personagem dificilmente se emociona por coisas subjetivas.', 'type' => 0],
        	['id' => 65, 'icon' => '1498616081.png', 'name' => 'Solitário', 'description' => 'Seu personagem prefere trabalhar sozinho.', 'type' => 0],
        	['id' => 66, 'icon' => '1498616104.png', 'name' => 'Criminoso', 'description' => 'Seu personagem é efetivamente um fora da lei.', 'type' => 1],
        	['id' => 67, 'icon' => '1498616141.png', 'name' => 'Apego à fé', 'description' => 'A fé é algo muito importante para o seu personagem. Esta fé provavelmente é o que suporta muitas de suas crenças e ações.', 'type' => 0],
        	...
        	['id' => 69, 'icon' => '1498616280.png', 'name' => 'Intimidador', 'description' => 'Seu personagem ameaça os indivíduos à sua volta como meio de persuasão.', 'type' => 1],
        	['id' => 70, 'icon' => '1498616356.png', 'name' => 'Implosivo', 'description' => 'Seu personagem guarda para si mesmo o que sente.', 'type' => 0],
        	['id' => 71, 'icon' => '1498616393.png', 'name' => 'Explosivo', 'description' => 'Seu personagem reage intensamente a todos os estímulos à sua volta sem passar por muitos crivos morais e racionais.', 'type' => 0],
        	['id' => 72, 'icon' => '1498616420.png', 'name' => 'Piadista', 'description' => 'Tudo existe pra que se tire um sarro.', 'type' => 1]
        ]);
    }
}
